...
US_M3_GRANT				= GameInfo.Units.UNIT_TANK_M3_GRANT.ID
...
IT_C202					= GameInfo.Units.UNIT_FIGHTER_C202_FOLGORE.ID
...
GE_JU88C				= GameInfo.Units.UNIT_FIGHTER_JU88C.ID
...
US_B25					= GameInfo.Units.UNIT_BOMBER_B25MITCHELL.ID
...
-- Unit that can support melee offensive with a ranged strike
g_OffensiveSupport = {
	[ARTILLERY] = true,
	[AT_GUN] = true,
}

-- Unit that can support melee defense with a ranged strike
g_DefensiveSupport = {
	[AT_GUN] = true,
	[ARTILLERY] = true,
}
