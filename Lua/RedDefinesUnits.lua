...
US_PRIEST				= GameInfo.Units.UNIT_MOBILE_ARTILLERY_PRIEST.ID
...
g_Major_Units = {
	...
	[ENGLAND] = {
		...
		UK_CHURCHILL, UK_A41, UK_A39, UK_ARCHER,
		...
		ARTILLERY, AA_GUN, AT_GUN, UK_MOBILE_AA_GUN, UK_MOBILE_BISHOP},
	[USSR] = {
	...
	[AMERICA] = {
		...
		US_PRIEST, US_SEXTON, US_ACHILLES,
		US_P36, US_P40, US_P51, US_P38, US_F2A, US_F4F, US_F6F, US_F4U,
