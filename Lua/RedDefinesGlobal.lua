...
PALACE =				GameInfo.Buildings.BUILDING_PALACE.ID
-- Events
WAR_POLAND  = GameInfo.Buildings.BUILDING_WAR_POLAND.ID
WAR_ALLIES  = GameInfo.Buildings.BUILDING_WAR_ALLIES.ID
WAR_WINTER  = GameInfo.Buildings.BUILDING_WAR_WINTER.ID
WAR_NORWAY  = GameInfo.Buildings.BUILDING_WAR_NORWAY.ID
WAR_ITALY  = GameInfo.Buildings.BUILDING_WAR_ITALY.ID
WAR_LOW_COUNTRIES  = GameInfo.Buildings.BUILDING_WAR_LOW_COUNTRIES.ID
WAR_GREECE  = GameInfo.Buildings.BUILDING_WAR_GREECE.ID
WAR_RUSSIA  = GameInfo.Buildings.BUILDING_WAR_RUSSIA.ID
WAR_CHINA  = GameInfo.Buildings.BUILDING_WAR_CHINA.ID
WAR_AMERICA  = GameInfo.Buildings.BUILDING_WAR_AMERICA.ID
WAR_JAPAN  = GameInfo.Buildings.BUILDING_WAR_JAPAN.ID

FALL_POLAND  = GameInfo.Buildings.BUILDING_FALL_POLAND.ID
FALL_FRANCE  = GameInfo.Buildings.BUILDING_FALL_FRANCE.ID
FALL_AUSTRIA  = GameInfo.Buildings.BUILDING_FALL_AUSTRIA.ID
FALL_CZECH  = GameInfo.Buildings.BUILDING_FALL_CZECH.ID
FALL_ALBANIA  = GameInfo.Buildings.BUILDING_FALL_ALBANIA.ID
FALL_BALTIC  = GameInfo.Buildings.BUILDING_FALL_BALTIC.ID

EVENT_LEND_LEASE  = GameInfo.Buildings.BUILDING_EVENT_LEND_LEASE.ID
