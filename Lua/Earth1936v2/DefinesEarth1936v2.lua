...
-- French Navy and Air Force
	{Name = "French metr. aviation", X = 13, Y = 33, Domain = "Air", CivID = FRANCE, Group = {FR_HAWK75, FR_HAWK75,} },
	{Name = "French Mediteranean fleet", X = 15, Y = 25, Domain = "Sea", CivID = FRANCE, Group = {FR_FANTASQUE, FR_FANTASQUE, FR_SUBMARINE, FR_BATTLESHIP_2,} },
	{Name = "French Atlantic fleet", X = 4, Y = 32, Domain = "Sea", CivID = FRANCE, Group = {FR_FANTASQUE, FR_FANTASQUE, FR_GALISSONIERE, FR_SUBMARINE, FR_SUBMARINE, FR_GALISSONIERE, FR_BATTLESHIP,} },
-- German Navy and Air Force
	{Name = "German Luftwaffe", X = 23, Y = 38, Domain = "Air", CivID = GERMANY, Group = {GE_BF109, GE_BF109, GE_HE111, GE_JU87,} },
	{Name = "German Luftwaffe AI Bonus", X = 23, Y = 38, Domain = "Air", AI = true, CivID = GERMANY, Group = {GE_HE111, GE_HE111, GE_HE111,} },
	{Name = "German Fleet", X = 26, Y = 42, Domain = "Sea", CivID = GERMANY, Group = {GE_BATTLESHIP_2, GE_DESTROYER, GE_BATTLESHIP,} },
	{Name = "German Submarine Fleet", X = 174, Y = 35, Domain = "Sea", CivID = GERMANY, Group = { GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE,} },
	{Name = "German Submarine Fleet AI bonus", X = 1, Y = 46, Domain = "Sea", AI = true, CivID = GERMANY, Group = { GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE, GE_SUBMARINE,} },
-- British Navy and Air Force
	{Name = "England Metropole RAF", X = 11, Y = 39, Domain = "Air", CivID = ENGLAND, Group = {UK_SPITFIRE, UK_SPITFIRE,} },
	{Name = "England Cairo RAF", X = 36, Y = 12, Domain = "Air", CivID = ENGLAND, Group = {UK_SPITFIRE} },
	{Name = "England Dehli RAF", X = 60, Y = 19, Domain = "Air", CivID = ENGLAND, Group = {UK_SPITFIRE} },
	{Name = "England Home fleet", X = 12, Y = 48, Domain = "Sea", CivID = ENGLAND, Group = {UK_TRIBA, UK_TRIBA, UK_DIDO, UK_BATTLESHIP, UK_BATTLESHIP_2, UK_ELIZABETH} },
	{Name = "England Mediterranean fleet", X = 36, Y = 16, Domain = "Sea", CivID = ENGLAND, Group = {UK_TRIBA, UK_TRIBA, UK_SUBMARINE, UK_ELIZABETH} },
	{Name = "England Pacific fleet", X = 65, Y = 7, Domain = "Sea", CivID = ENGLAND, Group = {UK_TRIBA, UK_DIDO, UK_SUBMARINE, UK_BATTLESHIP, UK_ELIZABETH} },
	{Name = "England Home fleet AI Bonus", X = 12, Y = 44, Domain = "Sea", AI = true, CivID = ENGLAND, Group = {UK_TRIBA, UK_TRIBA, UK_DIDO} },
-- Soviet Navy and Air Force
	{Name = "USSR central aviation", X = 40, Y = 40, Domain = "Air", CivID = USSR, Group = {RU_I16,} },
	{Name = "USSR central aviation AI Bonus", X = 40, Y = 40, Domain = "Air", AI = true,CivID = USSR, Group = {RU_I16,} },
	{Name = "USSR North fleet", X = 104, Y = 45, Domain = "Sea", CivID = USSR, Group = {RU_GANGUT, RU_GANGUT, RU_GNEVNY, RU_SUBMARINE} },
	{Name = "USSR Central fleet", X = 28, Y = 45, Domain = "Sea", CivID = USSR, Group = {RU_GANGUT,} },
-- Italian Navy and Air Force
	{Name = "Italian air", X = 19, Y = 25, Domain = "Air", CivID = ITALY, Group = {IT_CR42} },
	{Name = "Italian air Benghazi", X = 26, Y = 15, Domain = "Air", CivID = ITALY, Group = {IT_CR42} },
	{Name = "Italian fleet", X = 19, Y = 21, Domain = "Sea", CivID = ITALY, Group = {IT_SOLDATI, IT_SOLDATI, IT_ZARA, IT_DI_CAVOUR, IT_SUBMARINE, IT_BATTLESHIP} },
	{Name = "Italian Destroyer", X = 21, Y = 29, Domain = "Sea", CivID = ITALY, Group = {IT_SOLDATI} },
-- American Navy and Air Force
	{Name = "American Air Corps", X = 119, Y = 22, Domain = "Air", CivID = AMERICA, Group = {US_P36} },
	{Name = "American Pacific fleet", X = 132, Y = 24, Domain = "Sea", CivID = AMERICA, Group = {US_BATTLESHIP, US_CARRIER, US_FLETCHER, US_BALTIMORE, US_FLETCHER, US_SUBMARINE, US_FLETCHER} },
	{Name = "American Atlantic Fleet", X = 158, Y = 31, Domain = "Sea", CivID = AMERICA, Group = {US_BATTLESHIP, US_FLETCHER, US_BALTIMORE, US_FLETCHER, US_FLETCHER} },
	{Name = "American Suez Fleet", X = 149, Y = 6, Domain = "Sea", CivID = AMERICA, Group = {US_SUBMARINE, US_SUBMARINE} },
-- Imperial Japanese Navy and Air Force
	{Name = "Japanese Manchurian Army", X = 88, Y = 36, Domain = "Land", AI = true, CivID = JAPAN, Group = {JP_INFANTRY, JP_INFANTRY, JP_INFANTRY, JP_INFANTRY} },
	{Name = "Japanese Air", X = 97, Y = 26, Domain = "Air", CivID = JAPAN, Group = {JP_ZERO, JP_ZERO, JP_ZERO} },
	{Name = "Japanese Korea Air", X = 89, Y = 29, Domain = "Air", CivID = JAPAN, Group = {JP_ZERO, JP_AICHI, JP_KI21} },
	{Name = "Japanese Air AI Bonus", X = 89, Y = 29, Domain = "Air", AI = true,CivID = JAPAN, Group = {JP_ZERO, JP_AICHI, JP_KI21} },
	{Name = "Japanese Western fleet", X = 91, Y = 14, Domain = "Sea", CivID = JAPAN, Group = {JP_SUBMARINE, JP_BATTLESHIP_2, JP_KAGERO, JP_TAKAO, JP_BATTLESHIP, JP_KAGERO, JP_KAGERO,} },
	{Name = "Japanese Eastern Fleet", X = 103, Y = 16, Domain = "Sea", CivID = JAPAN, Group = {JP_SUBMARINE, JP_TAKAO, JP_BATTLESHIP, JP_KAGERO, JP_KAGERO, JP_CARRIER, JP_CARRIER} },
-- Chinese Navy and Air Force
	{Name = "Chinese Army AI Bonus", X = 77, Y = 45, Domain = "Land", AI = true, CivID = CHINA, Group = {CH_INFANTRY, CH_INFANTRY, CH_INFANTRY, CH_INFANTRY, CH_INFANTRY} },
	{Name = "Chinese Air AI Bonus", X = 78, Y = 21, Domain = "Air", AI = true,CivID = CHINA, Group = {CH_P40N, CH_P40N} },
-- Greek Navy and Air Force
	{Name = "Greek fleet", X = 27, Y = 18, Domain = "Sea", CivID = GREECE, Group = {GR_GEORGIOS, GR_GEORGIOS} },
-- Republican Spain Navy and Air Force
	{Name = "Republican Spain air", X = 8, Y = 23, Domain = "Air", CivID = RSPAIN, IsMinor = true, Group = {RU_I16} },
-- Nationalist Spain Navy and Air Force
	{Name = "Nationalist Spain air", X = 9, Y = 25, Domain = "Air", CivID = NSPAIN, IsMinor = true, Group = {GE_JU87, GE_BF109} },
	{Name = "Nationalist Spain fleet", X = 3, Y = 29, Domain = "Sea", CivID = NSPAIN, IsMinor = true, Group = {DESTROYER, DESTROYER} },
}
...
g_Cities = {
	-- UNITED KINGDOM
		{X = 11, Y = 39, Key = true, Buildings = { HARBOR, SHIPYARD, FACTORY, BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- London
		{X = 10, Y = 45, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Edinburgh
		{X = 9, Y = 42, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, HOSPITAL}, }, -- Manchester
		{X = 10, Y = 40, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, HOSPITAL}, }, -- Birmingham
	-- GERMANY
		{X = 23, Y = 38, Key = true, Buildings = { BARRACKS, ARSENAL, ACADEMY, BANK, FACTORY }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Berlin
		{X = 19, Y = 40, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BARRACKS, FACTORY}, }, -- Hamburg
		{X = 21, Y = 32, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BARRACKS, FACTORY}, }, -- Munich
		{X = 20, Y = 35, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BARRACKS, FACTORY}, }, -- Frankfurt
	-- FRANCE
		{X = 13, Y = 33, Key = true, Buildings = { BANK, FACTORY, ARSENAL }, AIBuildings = {RADIO, HOSPITAL}, }, -- Paris
		{X = 15, Y = 27, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, HOSPITAL, BANK}, }, -- Marseille
		{X = 15, Y = 30, Key = true, Buildings = { BANK }, AIBuildings = {}, }, -- Lyon
		{X = 11, Y = 30, Key = true, Buildings = { BANK }, AIBuildings = {}, }, -- Bordeaux
	-- ITALY
		{X = 19, Y = 25, Key = true, Buildings = { HARBOR, BANK, BARRACKS }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY, BASE}, }, -- Rome
		{X = 21, Y = 22, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- Naples
		{X = 19, Y = 28, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Milan
	-- U.S.S.R.
	    {X = 40, Y = 40, Key = true, Buildings = { BARRACKS, ARSENAL }, AIBuildings = {RADIO, HOSPITAL, BANK, FACTORY, BASE}, }, -- Moscow
		{X = 41, Y = 35, Key = true, Buildings = {}, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BANK}, }, -- Stalingrad
		{X = 33, Y = 45, Key = true, Buildings = { HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BANK, BASE}, }, -- Leningrad
		{X = 33, Y = 40, Key = true, Buildings = {}, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BANK}, }, -- Minsk
		{X = 34, Y = 34, Key = true, Buildings = {}, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BANK}, }, -- Kiev
		{X = 35, Y = 29, Key = true, Buildings = { HARBOR }, AIBuildings = {RADIO, HOSPITAL}, }, -- Stevaspol
		{X = 46, Y = 37, Key = true, Buildings = {}, AIBuildings = {RADIO, FACTORY, HOSPITAL}, }, -- Kuybyshev
		{X = 66, Y = 40, Key = true, Buildings = {}, AIBuildings = {RADIO, FACTORY, HOSPITAL, BARRACKS}, }, -- Novosibirsk
	-- AMERICA
		{X = 156, Y = 30, Key = true, Buildings = { ACADEMY, BANK, ARSENAL, HARBOR }, AIBuildings = {RADIO, HOSPITAL, BARRACKS, BASE}, }, -- Washington
		{X = 144, Y = 24, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- Dallas
		{X = 132, Y = 30, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- San Francisco
		{X = 132, Y = 27, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- Los Angeles
		{X = 149, Y = 29, Key = true, Buildings = {}, AIBuildings = {RADIO, HOSPITAL, BANK}, }, -- St. Louis
		{X = 132, Y = 35, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- Seattle
		{X = 150, Y = 33, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, RADIO, HOSPITAL, FACTORY, BARRACKS}, }, -- Chicago
		{X = 159, Y = 34, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- Boston
		{X = 157, Y = 33, Key = true, Buildings = { HARBOR, BANK, RADIO }, AIBuildings = {ARSENAL, HOSPITAL, FACTORY}, }, -- New York
		{X = 153, Y = 34, Key = true, Buildings = { BANK, FACTORY}, AIBuildings = {RADIO, BANK, HOSPITAL}, }, -- Detriot
	-- JAPAN
		{X = 97, Y = 26, Key = true, Buildings = { BANK, FACTORY, ARSENAL, BARRACKS, HARBOR, SHIPYARD, BASE }, AIBuildings = {RADIO, HOSPITAL}, }, -- Tokyo
		{X = 94, Y = 25, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, HOSPITAL}, }, -- Osaka
		{X = 96, Y = 35, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Sapparo
		{X = 89, Y = 29, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Seoul
	-- CHINA
		{X = 85, Y = 25, Key = true, Buildings = { BANK, BARRACKS }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, FACTORY}, }, -- Nanjing
		{X = 88, Y = 24, Key = true, Buildings = { HARBOR, BANK, FACTORY }, AIBuildings = {RADIO, ARSENAL, HOSPITAL, BARRACKS}, }, -- Shanghai
		{X = 82, Y = 32, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Peking
		{X = 78, Y = 21, Key = true, Buildings = { BANK, BARRACKS }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Chongqing
		{X = 82, Y = 15, Key = true, Buildings = { BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Guangzhou
	-- GREECE
		{X = 29, Y = 22, Key = true, Buildings = { BANK, HARBOR }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Athens
		{X = 26, Y = 21, Key = true, Buildings = { HARBOR, BANK }, AIBuildings = {RADIO, ARSENAL, HOSPITAL}, }, -- Patras
}
