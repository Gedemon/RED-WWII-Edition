...
ScenarioCivilizations = {
	...
	[7] = "CIVILIZATION_GREECE",
	[8] = "CIVILIZATION_CHINA",
	[9] = "CIVILIZATION_AMERICA",
}
...
scenarioMap = Modding.GetEvaluatedFilePath(myModId, myModVersion, "1936_EarthType2.Civ5Map");
...
Controls.StartButton:RegisterCallback(Mouse.eLClick, function()
	...
	elseif (not g_bDataLoaded ) then
		...
		modUserData.SetValue("RedLoading", "Earth1936v2")
