...
scenarioMap = Modding.GetEvaluatedFilePath(myModId, myModVersion, "Europe_1939_small.Civ5Map");
...
Controls.StartButton:RegisterCallback(Mouse.eLClick, function()
	...
	elseif (not g_bDataLoaded ) then
		...
		modUserData.SetValue("RedLoading", "SmallEuro1940")
...
function Initialize()
	...
	print("-------------------------------------")
	print ("R.E.D WW2 - Small Europe 1940 setup screen")
